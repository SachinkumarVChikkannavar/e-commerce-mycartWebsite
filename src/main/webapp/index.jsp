<%-- 
    Document   : index
    Created on : Jan 21, 2022, 6:54:30 PM
    Author     : Sachinkumar V C
--%>
                            ...
                            <div class="card-columns">
                                ...
                                <div class="card product-card">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button class="btn btn-outline-success"> &#8377; <%= p.getPriceAfterApplyingDisount()%>/- <span class="text-secondary disount-label">  &#8377; <%= p.getpPrice()%> <%= p.getpDiscount()%>%  off </span> </button>
                                    </div>
                                </div>
